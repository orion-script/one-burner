...
const Better = () => {
    return ( 
        <div className="bg-[#7837F8] w-full h-[19rem] mb-10 py-10 text-center text-white">
            <h2 className="font-bold text-xl md:text-4xl" data-aos="fade-up">Choose a better way to work</h2>
            <p className="font-medium text-lg md:text-2xl mt-5" data-aos="fade-down">No credit card details | No additional installation | No time wasting</p>
